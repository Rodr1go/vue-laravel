        ...
        <div class="card">
          <div class="card-header p-2">
            <ul class="nav nav-pills">
              <li class="nav-item">
                <a class="nav-link" href="#activity" data-toggle="tab">Atividade</a>
              </li>
              <li class="nav-item">
              ...
              <div class="tab-pane active" id="settings">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <textarea v-model="form.bio" class="form-control" id="inputExperience" placeholder="Experiência"></textarea>
    ...
    updateProfile(e) {
      ...
      if(file['size'] < 2111775) {
        ...
        Swal.fire({
          type: 'error',
          title: 'Oops...',
          text: 'O arquivo que você enviou é muito grande!'
        });
      }
