    ...
    <div class="row justify-content-center">
      <div class="col-md-10 mt-4">
        ...
        <svg
          ...
          <title>content</title>
          <ellipse cx="1023.75" cy="834.07" rx="100.11" ry="24.73" fill="#6c63ff" opacity="0.1" />
          <ellipse cx="140.04" cy="838.19" rx="100.11" ry="24.73" fill="#6c63ff" opacity="0.1" />
          <path
          ...
          <path
            ...
            fill="#5a5773"
          />
          <g id="83eb5f8b-b68b-4721-b047-6100bc74156f" data-name="buttons">
            <circle cx="96.72" cy="164.18" r="6.5" fill="#fff" />
            <circle cx="114.22" cy="164.18" r="6.5" fill="#fff" />
            <circle cx="131.72" cy="164.18" r="6.5" fill="#fff" />
          </g>
          <rect
            x="141.22"
            y="293.86"
          ...
          <path
            ...
            fill="#ffd037"
          />
          <ellipse cx="713.64" cy="758.15" rx="62" ry="9.51" fill="#6c63ff" opacity="0.1" />
          <path
          ...
          <circle cx="935.51" cy="546.26" r="0.23" fill="#e6e8ec" />
          <rect
            x="849.12"
            y="551.42"
            width="181.18"
          ...
          <rect
            ...
            fill="#6c63ff"
          />
          <rect x="886.13" y="652.15" width="103.43" height="7.86" fill="#6c63ff" />
          <rect x="868.55" y="668.74" width="142.32" height="7.86" fill="#6c63ff" />
          <rect x="868.55" y="686.2" width="142.32" height="7.86" fill="#6c63ff" />
          <rect x="868.55" y="703.66" width="142.32" height="7.86" fill="#6c63ff" />
          <rect y="482.59" width="426.61" height="208.22" rx="6.61" ry="6.61" fill="#fff" />
          <rect
            y="482.59"
            width="426.61"
            height="208.22"
          ...
          <rect
            ...
            fill="#6c63ff"
          />
          <rect x="87.15" y="583.32" width="243.53" height="7.86" fill="#6c63ff" />
          <rect x="45.75" y="599.91" width="335.1" height="7.86" fill="#6c63ff" />
          <rect x="45.75" y="617.37" width="335.1" height="7.86" fill="#6c63ff" />
          <rect x="45.75" y="634.83" width="335.1" height="7.86" fill="#6c63ff" />
          <path
